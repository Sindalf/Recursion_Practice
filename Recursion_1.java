public class Recursion_1 {
    ...
    public String changeXY(String str) {
        ...
        return c1 + changeXY(str.substring(1));
    }
    ...
    public String allStar(String str) {
        ...
        char c1 = str.charAt(0);
        return c1 + "*" + allStar(str.substring(1));
    }
    ...
    public String pairStar(String str) {
        ...
        if (c1 == c2) {
            return c1 + "*" + pairStar(str.substring(1));
        }
        return c1 + pairStar(str.substring(1));
    }
    ...
    public String endX(String str) {
        ...
        char c1 = str.charAt(0);
        if (c1 == 'x') {
            return endX(str.substring(1)) + c1;
        }
        return c1 + endX(str.substring(1));
    }
    ...
    public String stringClean(String str) {
        ...
        return c1 + stringClean(str.substring(1));
    }
    ...
    public int strDist(String str, String sub) {
        ...
        int first = str.length() - sub.length();
        if (!str.substring(first, str.length()).equals(sub)) {
